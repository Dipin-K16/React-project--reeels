...
const SendMessages = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (mobileNumber.length < 1) {
      ...
      window.open(
        "https://web.whatsapp.com/send?phone=918137839779&text=message&app_absent=0"
      );
      //  axios.get('https://web.whatsapp.com/send?phone=918137839779&text=message&app_absent=0')
